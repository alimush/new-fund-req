// /models/ReplaceBookingTransfer.js
...
const ReplaceBookingTransferSchema = new mongoose.Schema(
  {
    ...
    createdById: { type: String, default: "" },    // optional
...
export default mongoose.models.ReplaceBookingTransfer ||
  mongoose.model("ReplaceBookingTransfer", ReplaceBookingTransferSchema);