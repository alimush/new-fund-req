...
export const CHEQUE_TEMPLATES = [
  {
    ...
    fields: [
      ...
      { key: "text", label: "text", type: "textarea", top: 60, left: 4, width: 90, height: 10, multiline: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "text", label: "text", type: "textarea", top: 58, left: 10, width: 86, height: 10, multiline: true },
    ],
  },
];
