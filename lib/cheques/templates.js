...
export const CHEQUE_TEMPLATES = [
  {
    ...
    name: "صكوك المصرف العقاري",
    subtitle: "REAL ESTATE BANK OF IRAQ — اختر الفرع",
  ...
  },
  {
    ...
    name: "مصرف المستشار",
    subtitle: "ALMUSTASHAR ISLAMIC BANK — اختر الفرع",
  ...
  {
    key: "rafidain_ghadeer",
    name: "صكوك مصرف الرافدين",
    subtitle: "RAFIDAIN BANK — اختر الفرع",
...
export function isPrintField(f) {
  if (f?.type === "dateSlash") return true;
