...
/** HTML لطباعة صورة القالب فقط — نفس موضع «طباعة على صك فارغ» */
...
<body>
  ...
  <div class="cheque-sheet">
    <div class="cheque-inner">
      ...
      <img src="${esc(src)}" alt="" crossorigin="anonymous" style="position:absolute;width:0;height:0;opacity:0;pointer-events:none;" aria-hidden="true" />
    </div>
  </div>
  </div>
  ${chequePrintReadyScript()}
