  ...
  const formalBody = isAttachmentOnly
    ? `
      <p style="margin:0 0 12px 0;">
        مرفق لكم الاتاج الخاص بـ <b style="color:#f8fafc">${safeTypeAr}</b>
        والمقدم من قبل السيد/ة <b style="color:#f8fafc">${safeActor}</b>.
      </p>
      <p style="margin:0 0 12px 0;">
        يرجى الاطلاع على المرفق للعلم والمتابعة.
      </p>
    ...
    <div style="max-width:720px;margin:0 auto;padding:22px 14px">
      ...
      ">
        <div style="
          ...
          text-align:right;
        ">
          ${isAttachmentOnly ? "إشعار رسمي بخصوص الاتاج المرفق" : `إشعار رسمي بخصوص ${escapeHtml(typeAr)}`}
        </div>
