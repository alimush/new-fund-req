export const PERMISSIONS = {
  ...
  /** إدارة قوالب موافقات طلبات الحجز (EX Workflow) */
  EX_WORKFLOW: "EX_WORKFLOW",
  ...
  VOUCHERS_BADUR_BAGHDAD_SAFEBOX_ISTISHAR:
    "VOUCHERS_BADUR_BAGHDAD_SAFEBOX_ISTISHAR",
  VOUCHERS_BADUR_BAGHDAD_ELITE: "VOUCHERS_BADUR_BAGHDAD_ELITE",
  TEST: "TEST",
  ...
  CHEQUES: "CHEQUES",
  /** ترتيب حقول الصكوك — وضع الإدخال / ترتيب الحقول */
  CHEQUES_FIELD_LAYOUT: "CHEQUES_FIELD_LAYOUT",
  /** @deprecated استخدم CHEQUES_FIELD_LAYOUT */
...
const PERMISSION_LEGACY_ALIASES = {
  ...
  [PERMISSIONS.CHEQUES_FIELD_LAYOUT]: [
    PERMISSIONS.CHEQUES_EDITOR,
    "editor صكوك",
  ],
...
export function normalizePermissions(permissions) {
  ...
  const legacyToCanonical = {
    ...
    "editor صكوك": PERMISSIONS.CHEQUES_FIELD_LAYOUT,
  };
  return [
    ...new Set(
...
export const PERMISSION_LABELS = {
  ...
  [PERMISSIONS.DUPLICATE_REQUEST]: "تكرار طلب",
  ...
  [PERMISSIONS.EX_WORKFLOW]: "وورك فلو طلبات الحجز (EX)",
  ...
  [PERMISSIONS.VOUCHERS_AL_GHADEER]: "وصولات الغدير (رئيسي)",
  [PERMISSIONS.VOUCHERS_BADUR_BAGHDAD]: "وصولات بدور بغداد",
  [PERMISSIONS.VOUCHERS_TIBA_AL_NAJAF]: "وصولات طيبة النجف",
  [PERMISSIONS.VOUCHERS_GHADEER_KARBALA]: "وصولات غدير كربلاء (رئيسي)",
  [PERMISSIONS.VOUCHERS_BADUR_AL_NAJAF]: "وصولات بدور النجف",
  [PERMISSIONS.VOUCHERS_GHADEER_INVESTMENTS]: "وصولات غدير للاستثمارات (فرعي)",
  [PERMISSIONS.VOUCHERS_GHADEER_KARBALA_SUB]: "وصولات غدير كربلاء - صندوق فرعي",
  ...
  [PERMISSIONS.VOUCHERS_BADUR_BAGHDAD_ELITE]:
    "وصولات بدور بغداد - Elite",
  [PERMISSIONS.TEST]: "testوصولات",

  [PERMISSIONS.CHEQUES]: "صكوك",
  [PERMISSIONS.CHEQUES_FIELD_LAYOUT]: "ترتيب حقول الصكوك (وضع الإدخال)",
  [PERMISSIONS.CHEQUES_EDITOR]: "editor صكوك (قديم)",
};
