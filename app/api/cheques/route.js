...
export async function POST(req) {
  try {
    ...
    const doc = await Cheque.create({
      ...
      amountWordsLine2: String(body?.amountWordsLine2 || "").trim(),
      text: String(body?.text || "").trim(),
      textFieldLayout: body?.textFieldLayout || undefined,
      amountWordsLayout: body?.amountWordsLayout || undefined,
      amountWordsLine2Layout: body?.amountWordsLine2Layout || undefined,
